  ...
  return (
    <Fade> 
      <div className="min-h-screen flex flex-col items-center justify-center text-center mt-4 md:mt-20 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center text-center gap-6 bg-gradient-to-bl from-[#000000] to-[#866aff]  p-8 rounded-[35px] w-11/12  md:w-3/4">
          ...
          <div className="card text-white p-6 flex flex-col">
            ...
            <div className="icons flex flex-row items-center text-center gap-4 text-3xl">
              <SiCisco />
              <SiObsstudio />
              <FaGithub />
              <TbBrandOffice />
